####################################################################
# Disease-Assoicated Microbiome base Blood Screening (DAMBSpy)
# Copyright (C) 2024  Brain-Pod
#
...
#
# Script: dambs-primer
# Description: Generate and execute genome download and processing commands for unique bacterial gene sequences, ensuring unique ddPCR primer design.
# Part of the DAMBSpy distribution.
# Licensed under the GNU General Public License v3.0 (GPLv3).
# See https://www.gnu.org/licenses/gpl-3.0.html for details.
#
# Author: Brain-Pod
# License: GPLv3
# Maintainer: jihwan.park@brain-pod.com
# Status: Development
